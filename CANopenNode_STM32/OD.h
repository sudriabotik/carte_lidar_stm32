...
typedef struct {
    ...
    uint16_t x2000_ACTION_ID;
    int16_t x2001_param_1;
    int16_t x2002_param_2;
    int16_t x2003_param_3;
    int16_t x2004_param_4;
    int16_t x2005_param_5;
    int16_t x2006_param_6;
    uint16_t x2007_command_ID;
    uint8_t x2100_current_command_status;
    uint16_t x2101_current_command_id;
    uint16_t x2102_current_action_id;
    uint16_t x2103_last_completed_command_id;
    uint8_t x2104_command_error_code;
